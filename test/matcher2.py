...
def find_song_in_audio(long_audio, reference_fingerprints, window_size=15.0, hop_size=5.0, sample_rate=44100, similarity_threshold=0.15):
    """
    ...
    for i, start_time in enumerate(window_starts):
        ...
        for song_name, reference_fingerprint in reference_fingerprints.items():
            similarity, offset = compare_fingerprints(window_fingerprint, reference_fingerprint)
        ...
        if best_similarity >= similarity_threshold:
            ...
            if song_start_time >= 0:
                ...
                audio_progress += reference_fingerprint['duration']
